  ...
  <div class="relative inline-flex w-full">
    ...
    >
      <span class="flex items-center">
        <span class="font-normal text-gray-800">{{activeLang}}</span>
      </span>
      ...
      <div v-show="dropdownOpen" class="z-10 absolute top-full left-0 w-full bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
        ...
        >
          ...
          <button
            ...
            :class="lang.name === activeLang && 'text-indigo-500'"
            @click="activeLang = lang.name; dropdownOpen = false"
          >
            <span>{{lang.name}}</span>
            <svg class="shrink-0 ml-2 fill-current text-indigo-400" :class="{'invisible': lang.name != activeLang}" width="12" height="9" viewBox="0 0 12 9">
