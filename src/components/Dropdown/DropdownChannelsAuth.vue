      ...
      <div v-show="dropdownOpen" class="z-10 absolute top-full left-0 min-w-[200px] w-full bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
        ...
        >
          ...
          >
            ...
            <svg class="shrink-0 ml-2 fill-current text-indigo-400" :class="channel.id !== selectedInList && 'invisible'" width="12" height="9" viewBox="0 0 12 9">
...
export default {
  ...
  computed: {
    ...
    selectedInList() {
      return this.channels[this.selected].id || 0
    }
  },
  setup() {
