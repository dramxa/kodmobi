        ...
        <router-link to="/settings" custom v-slot="{ href, navigate, isExactActive }">
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-gray-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-gray-700'">Main Settings</span>
            </a>
          </li>
        </router-link>
        <router-link to="/settings/channels" custom v-slot="{ href, navigate, isExactActive }">
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              <svg class="w-4 h-4 shrink-0 fill-current text-gray-400 mr-2" :class="isExactActive && 'text-indigo-400'" viewBox="0 0 16 16">
                <path d="M14.3.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-8 8c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l8-8zM15 7c.6 0 1 .4 1 1 0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8c.6 0 1 .4 1 1s-.4 1-1 1C4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6c0-.6.4-1 1-1z" />
              </svg>
              <span class="text-sm font-medium text-gray-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-gray-700'">Channels</span>
            </a>
          </li>
        </router-link>
      </ul>
