<template>
  <div class="flex flex-nowrap no-scrollbar md:block px-3 py-6 border-b md:border-b-0 md:border-r border-gray-200 min-w-60 md:space-y-3">
    <section class="mb-5 relative">
      <div class="flex items-center justify-center flex-col">
        <div class="mb-5">
          <img class="w-20 h-20 rounded-full" src="@/assets/user-avatar-80.png" width="80" height="80" alt="User upload" />
        </div>
        <DropdownEditMenu class="absolute top-0 right-0 inline-flex" @click="editName($event)">
          <li>
            <span
              @click.stop=""
    ...
    <!-- Group 1 -->
    <div>
      <div class="text-xs font-semibold text-gray-400 uppercase mb-3">Account</div>
      <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
        <router-link to="/profile/setting" custom v-slot="{ href, navigate, isExactActive }">
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-gray-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-gray-700'">Personal settings</span>
            </a>
          </li>
        </router-link>
        <!-- <router-link to="/settings/notifications" custom v-slot="{ href, navigate, isExactActive }">
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-gray-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-gray-700'">Billing information</span>
            </a>
          </li>
        </router-link> -->
        ...
        <router-link to="/profile/billing" custom v-slot="{ href, navigate, isExactActive }">
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              <svg class="w-4 h-4 shrink-0 fill-current text-gray-400 mr-2" :class="isExactActive && 'text-indigo-400'" viewBox="0 0 16 16">
